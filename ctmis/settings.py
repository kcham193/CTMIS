"""
Django settings for ctmis project.
...
SECRET_KEY = 'django-insecure-0er(%=5p@a5@xp*r1@=0*24p)_eo5@60=e$ubjeo2$k_jwa_2x'
...
WSGI_APPLICATION = 'ctmis.wsgi.application'
...
LOGIN_REDIRECT_URL = '/ctmis/dashboard/'
